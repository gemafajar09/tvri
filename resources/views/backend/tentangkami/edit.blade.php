    ...
    <div class="col-md-12">
        ...
        <div class="card card-primary card-outline">
            <div class="card-header">
                ...
                <center>
                    <h5 style="margin-left:20px" class="m-0">Tentang Kami</h5>
                </center>
            </div>
            <div class="card-body">
                <form action="{{route('saveinfo')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <input type="hidden" name="id_tentang" value="{{$edit->id_tentang}}">
                    ...
                    <div class="form-group" id="satu" style="display:none">
                        <textarea name="isi" class="ckeditor">{{$edit->isi}}</textarea>
                    </div>
